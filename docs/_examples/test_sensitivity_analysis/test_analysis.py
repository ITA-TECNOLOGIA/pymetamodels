...
class analysis(object):
    ...
    .. _model_coupled_function_test_sensitivity_analysis:
    ...
    **Synopsis:**
    ...
    def __init__(self):
        ...
        ## Initial variables
        self.name = "test_sensitivity_analysis"
    ...
    def run_model(self):
        ...
        for case in self.mita.keys():
            print("*:-)* Printing data object structure for case %s sensitivity case %s" % (case,self.mita.sensitivity_type(case)))
